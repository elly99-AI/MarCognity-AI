...
The Epistemic Integrity Stress Test is an independent protocol designed to evaluate the epistemic robustness of texts generated by language models. Inspired by a neuropsychological perspective, it exposes the gap between linguistic coherence and actual evidential grounding, revealing blind spots, confabulations, omissions, and unmonitored inferences. It is a generic, reproducible tool applicable to any autoregressive model, whether closed or open.
...
| **MarCognity-AI** | [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17855185.svg)](https://doi.org/10.5281/zenodo.21825761) |
|---|---|
| **Permanent DOI** | `https://doi.org/10.5281/zenodo.21825761` |
| **Access Publication** | [Full Research Paper (PDF) & Code (Zenodo)](https://doi.org/10.5281/zenodo.21825761) |
